package tl.com.easy_recycleview_library.ItemDecoration;
...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
      ...
      BaseRecyclerViewAdapter BaseRecyclerViewAdapter;
        ...
        drawHorizontal(c,parent,BaseRecyclerViewAdapter);
        drawVertical(c,parent,BaseRecyclerViewAdapter);
    }

    public void drawHorizontal(Canvas c, RecyclerView parent, BaseRecyclerViewAdapter adapter) {
    ...
    public void drawVertical(Canvas c, RecyclerView parent, BaseRecyclerViewAdapter adapter) {
        int count = parent.getChildCount();
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
      ...
      BaseRecyclerViewAdapter BaseRecyclerViewAdapter;
        ...
        applyItemVerticalOffsets(outRect, itemPosition, childCount, spanLookup.getSpanCount(), spanLookup,BaseRecyclerViewAdapter);
    }
    ...
    private void applyItemVerticalOffsets(Rect outRect, int itemPosition, int childCount, int spanCount, SpanLookup spanLookup,BaseRecyclerViewAdapter adapter) {
    ...
    private static int getItemTopSpacing(SpanLookup spanLookup, int verticalSpacing, int itemPosition, int spanCount, int childCount, BaseRecyclerViewAdapter adapter) {
    ...
    private static int getItemBottomSpacing(SpanLookup spanLookup, int verticalSpacing, int itemPosition, int childCount, BaseRecyclerViewAdapter adapter) {
