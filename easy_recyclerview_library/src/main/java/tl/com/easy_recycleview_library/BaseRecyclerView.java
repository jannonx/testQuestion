...
import tl.com.easy_recycleview_library.view.ArrowRefreshHeader;
import tl.com.easy_recycleview_library.view.LoadingFooter;
...
public class BaseRecyclerView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mWrapAdapter = (BaseRecyclerViewAdapter) adapter;
...
//        }
    ...
    private class DataObserver extends RecyclerView.AdapterDataObserver {
        ...
        public void onChanged() {
            ...
            if (adapter instanceof BaseRecyclerViewAdapter) {
                BaseRecyclerViewAdapter lRecyclerViewAdapter = (BaseRecyclerViewAdapter) adapter;
     ...
     * 设置Footer颜色
     *
     * @param indicatorColor  加载动画颜色
     * @param hintColor       文字颜色
     ...
     */
    public void refresh() {
        if (mRefreshHeader.getVisibleHeight() > 0 || mRefreshing) {// if RefreshHeader is Refreshing,
            // return
            return;
        }
