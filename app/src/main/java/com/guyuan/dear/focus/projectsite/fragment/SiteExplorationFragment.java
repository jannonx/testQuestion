...
import com.guyuan.dear.focus.projectsite.adapter.SiteExplorationAdapter;
 ...
 */
public class SiteExplorationFragment extends BaseListSearchFragment<SimpleTabBean, FragmentListBinding, FocusProjectSiteViewModel> {
    ...
    protected void init() {
        SiteExplorationAdapter siteExplorationAdapter = new SiteExplorationAdapter(getContext(),
                listData, R.layout.item_focus_site_exploration);
