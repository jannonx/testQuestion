 ...
 */
public class ProviderAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public ProviderAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
