...
import com.guyuan.dear.databinding.ItemNewContractListBinding;
 ...
 **/
public class NewContractListAdapter extends BaseDBRecycleAdapter<BaseContractBean, ItemNewContractListBinding> {
    public NewContractListAdapter(List<BaseContractBean> listData) {
        super(listData, R.layout.item_new_contract_list);
    }

    @Override
    protected void bindDataToView(Holder holder, BaseContractBean item, int position) {
        ItemNewContractListBinding binding = DataBindingUtil.getBinding(holder.itemView);
