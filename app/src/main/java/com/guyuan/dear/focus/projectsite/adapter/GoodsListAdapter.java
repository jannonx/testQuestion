 ...
 */
public class GoodsListAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public GoodsListAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
