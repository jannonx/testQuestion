 ...
 */
public class ProjectInstallAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public ProjectInstallAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
