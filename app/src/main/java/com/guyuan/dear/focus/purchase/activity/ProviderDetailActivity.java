...
import com.guyuan.dear.focus.purchase.fragment.ProviderDetailFragment;
 ...
 */
@AndroidEntryPoint
public class ProviderDetailActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, FocusPurchaseViewModel> {
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        ProviderDetailFragment mFragment = ProviderDetailFragment.newInstance();
        ActivityUtils.addFragmentToActivity(fragmentManager, mFragment, R.id.fragment_container,
                ProviderDetailFragment.TAG);
    }
