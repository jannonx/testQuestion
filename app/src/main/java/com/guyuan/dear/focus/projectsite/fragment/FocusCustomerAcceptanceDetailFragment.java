...
/**
 * @description: 我的关注--工程现场--客户验收报告--详情页面
 * @author: 许建宁
 * @since: 2020/11/11 11:20
 * @company: 固远（深圳）信息技术有限公司
 */
public class FocusCustomerAcceptanceDetailFragment extends BaseDataBindingFragment<FragmentFocusCustomerAcceptanceBinding, FocusProjectSiteViewModel>
   {

    public static final String TAG = FocusCustomerAcceptanceDetailFragment.class.getSimpleName();

    private static final int REQUEST_SEND_SELECT_PERSON = 0x001;
    private static final int REQUEST_COPY_SELECT_PERSON = 0x002;
    private AcceptanceRecordFragment statusFragment;
    private ProjectInstallFragment planFragment;
    ...
    protected int getLayoutID() {
        return R.layout.fragment_focus_customer_acceptance;
    }
