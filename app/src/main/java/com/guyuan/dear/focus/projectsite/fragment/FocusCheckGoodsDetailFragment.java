...
import com.guyuan.dear.databinding.FragmentFocusCheckGoodBinding;
 ...
 */
public class FocusCheckGoodsDetailFragment extends BaseDataBindingFragment<FragmentFocusCheckGoodBinding, FocusProjectSiteViewModel> {

    public static final String TAG = FocusCheckGoodsDetailFragment.class.getSimpleName();
    ...
    private CheckGoodsListFragment planFragment;
    ...
    public static FocusCheckGoodsDetailFragment newInstance(ProjectReportType data) {
        Bundle bundle = new Bundle();
        FocusCheckGoodsDetailFragment fragment = new FocusCheckGoodsDetailFragment();
    ...
    protected int getLayoutID() {
        return R.layout.fragment_focus_check_good;
    }
...
//        produceBean = (FocusProduceBean) arguments.getSerializable(ConstantValue.KEY_CONTENT);
    ...
    private void initViewPager() {
        ...
        planFragment = CheckGoodsListFragment.newInstance();
