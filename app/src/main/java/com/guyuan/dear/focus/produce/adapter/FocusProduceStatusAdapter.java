 ...
 */
public class FocusProduceStatusAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public FocusProduceStatusAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
