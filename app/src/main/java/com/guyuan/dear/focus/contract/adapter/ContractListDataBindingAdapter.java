 ...
 **/
public class ContractListDataBindingAdapter extends BaseDBRecycleAdapter<BaseContractBean, ItemContractListBinding> {
    public ContractListDataBindingAdapter(List<BaseContractBean> listData) {
        super(listData, R.layout.item_contract_list);
    }
