 ...
 */
@AndroidEntryPoint
public class FocusInstallationDebugAllActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, FocusProjectSiteViewModel> {

    public static void start(Context context, ProjectReportType data) {
        Intent intent = new Intent(context, FocusInstallationDebugAllActivity.class);
