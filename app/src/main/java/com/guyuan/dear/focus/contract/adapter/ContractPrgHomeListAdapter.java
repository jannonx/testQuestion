 ...
 **/
public class ContractPrgHomeListAdapter extends BaseRecyclerAdapter<BaseContractBean> {
    public ContractPrgHomeListAdapter(Context context, @NonNull List<BaseContractBean> listData) {
