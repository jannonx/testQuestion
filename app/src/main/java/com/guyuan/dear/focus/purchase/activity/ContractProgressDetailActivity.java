 ...
 */
@AndroidEntryPoint
public class ContractProgressDetailActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, FocusPurchaseViewModel> {

    public static void start(Context context, String title) {
        Intent intent = new Intent(context, ContractProgressDetailActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        ContractProgressDetailFragment mFragment = ContractProgressDetailFragment.newInstance();
