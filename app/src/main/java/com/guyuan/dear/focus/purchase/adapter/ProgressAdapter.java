 ...
 */
public class ProgressAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public ProgressAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
