 ...
 */
@AndroidEntryPoint
public class FocusInstallationDebugDetailActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, FocusProjectSiteViewModel> {

    public static void start(Context context, ProjectReportType data) {
        Intent intent = new Intent(context, FocusInstallationDebugDetailActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        BaseFragment mFragment = FocusInstallationDebugDetailFragment.newInstance(bean);

        ActivityUtils.addFragmentToActivity(fragmentManager, mFragment, R.id.fragment_container,
                FocusInstallationDebugDetailFragment.TAG);
    }
