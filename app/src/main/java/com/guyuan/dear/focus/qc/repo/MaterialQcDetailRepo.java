...
//    }
    ...
    public Disposable getReportDetail(int reportId, DearNetHelper.NetCallback<MaterialQcReportDetail> callback) {
        return DearNetHelper.getInstance().getMaterialQcReportDetailById(reportId, new DearNetHelper.NetCallback<MaterialQcReportDetail>() {
            @Override
            ...
            public void onGetResult(MaterialQcReportDetail result) {
                getApproveFlow(result, callback);
            }
    ...
    private void getApproveFlow(MaterialQcReportDetail detail, DearNetHelper.NetCallback<MaterialQcReportDetail> callback) {
