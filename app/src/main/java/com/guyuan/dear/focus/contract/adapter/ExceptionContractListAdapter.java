...
import com.guyuan.dear.databinding.ItemExceptionContractListBinding;
 ...
 **/
public class ExceptionContractListAdapter extends BaseDBRecycleAdapter<BaseContractBean, ItemExceptionContractListBinding> {
    public ExceptionContractListAdapter(List<BaseContractBean> listData) {
        super(listData, R.layout.item_exception_contract_list);
    }

    @Override
    protected void bindDataToView(Holder holder, BaseContractBean item, int position) {
        ItemExceptionContractListBinding binding = DataBindingUtil.getBinding(holder.itemView);
