...
import com.guyuan.dear.focus.projectsite.adapter.CheckSafetyAdapter;
...
/**
 * @description: 我的关注--工程现场--安全排查
 * @author: Jannonx
 * @since: 2020/9/17 11:42
 * @company: 固远（深圳）信息技术有限公司
 */
public class CheckSafetyFragment extends BaseListSearchFragment<SimpleTabBean, FragmentListBinding, FocusProjectSiteViewModel> {
    ...
    protected void init() {
        CheckSafetyAdapter checkSafetyAdapter = new CheckSafetyAdapter(getContext(),
                listData, R.layout.item_focus_check_safety);
