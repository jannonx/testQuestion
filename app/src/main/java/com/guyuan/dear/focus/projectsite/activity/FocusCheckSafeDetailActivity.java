...
import com.guyuan.dear.focus.projectsite.fragment.FocusCheckSafeDetailFragment;
 ...
 */
@AndroidEntryPoint
public class FocusCheckSafeDetailActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, FocusProjectSiteViewModel> {

    public static void start(Context context, SiteExploreBean data) {
        Intent intent = new Intent(context, FocusCheckSafeDetailActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        BaseFragment mFragment = FocusCheckSafeDetailFragment.newInstance(bean);

        ActivityUtils.addFragmentToActivity(fragmentManager, mFragment, R.id.fragment_container,
                FocusCheckSafeDetailFragment.TAG);
    }
