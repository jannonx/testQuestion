 ...
 **/
public class ContractListAdapter extends BaseDBRecycleAdapter<BaseContractBean, ItemContractListBinding> {
    public ContractListAdapter(List<BaseContractBean> listData) {
