 ...
 */
public class OutSourceAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public OutSourceAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
