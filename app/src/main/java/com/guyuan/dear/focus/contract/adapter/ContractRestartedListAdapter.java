 ...
 **/
public class ContractRestartedListAdapter extends BaseDBRecycleAdapter<RestartedContractBean,ItemRestartedContractListBinding> {
    public ContractRestartedListAdapter(List<RestartedContractBean> listData) {
        super(listData, R.layout.item_restarted_contract_list);
    }

    @Override
    protected void bindDataToView(Holder holder, RestartedContractBean item, int position) {
