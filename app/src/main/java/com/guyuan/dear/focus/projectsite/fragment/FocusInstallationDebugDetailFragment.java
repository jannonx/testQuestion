...
import com.guyuan.dear.databinding.FragmentFocusInstallationDebugDetailBinding;
...
/**
 * @description: 我的关注--工程现场--安装调试报告--详情页面
 * @author: 许建宁
 * @since: 2020/11/11 11:20
 * @company: 固远（深圳）信息技术有限公司
 */
public class FocusInstallationDebugDetailFragment extends BaseDataBindingFragment<FragmentFocusInstallationDebugDetailBinding, FocusProjectSiteViewModel> {

    public static final String TAG = FocusInstallationDebugDetailFragment.class.getSimpleName();
    ...
    public static FocusInstallationDebugDetailFragment newInstance(ProjectReportType data) {
        Bundle bundle = new Bundle();
        FocusInstallationDebugDetailFragment fragment = new FocusInstallationDebugDetailFragment();
    ...
    protected int getLayoutID() {
        return R.layout.fragment_focus_installation_debug_detail;
    }
