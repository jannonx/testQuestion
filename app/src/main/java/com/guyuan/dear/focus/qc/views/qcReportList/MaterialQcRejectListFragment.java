 ...
 **/
public class MaterialQcRejectListFragment extends BaseMvvmFragment<FragmentProductQcPassListBinding, QcReportListViewModel> {
    ...
    public static MaterialQcRejectListFragment getInstance(long dateFrom, long dateTo){
        Bundle bundle = new Bundle();
        bundle.putLong(ConstantValue.KEY_DATE_START,dateFrom);
        bundle.putLong(ConstantValue.KEY_DATE_TO,dateTo);
        MaterialQcRejectListFragment fragment = new MaterialQcRejectListFragment();
    ...
    protected void initData() {
        ...
        getViewModel().upDateMaterialRejectList(start, end,pageIndex,pageSize);
