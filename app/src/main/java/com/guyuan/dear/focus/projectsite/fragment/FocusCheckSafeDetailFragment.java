...
/**
 * @description: 我的关注--工程现场--安全排查报告--详情页面
 * @author: 许建宁
 * @since: 2020/11/11 11:20
 * @company: 固远（深圳）信息技术有限公司
 */
public class FocusCheckSafeDetailFragment extends BaseDataBindingFragment<FragmentFocusCheckSafeBinding, FocusProjectSiteViewModel>
{

    public static final String TAG = FocusCheckSafeDetailFragment.class.getSimpleName();
    ...
    private CheckSafeContentFragment planFragment;
    ...
    protected int getLayoutID() {
        return R.layout.fragment_focus_check_safe;
    }
