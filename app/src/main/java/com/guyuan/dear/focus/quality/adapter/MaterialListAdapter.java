 ...
 */
public class MaterialListAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public MaterialListAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
