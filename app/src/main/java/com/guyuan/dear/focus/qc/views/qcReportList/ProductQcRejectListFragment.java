 ...
 **/
public class ProductQcRejectListFragment extends BaseMvvmFragment<FragmentProductQcPassListBinding, QcReportListViewModel> {
    ...
    public static ProductQcRejectListFragment getInstance(long dateFrom, long dateTo) {
        Bundle bundle = new Bundle();
        bundle.putLong(ConstantValue.KEY_DATE_START, dateFrom);
        bundle.putLong(ConstantValue.KEY_DATE_TO, dateTo);
        ProductQcRejectListFragment fragment = new ProductQcRejectListFragment();
    ...
    protected void initData() {
        ...
        getViewModel().upDateProductRejectList(start, end, pageIndex, pageSize);
