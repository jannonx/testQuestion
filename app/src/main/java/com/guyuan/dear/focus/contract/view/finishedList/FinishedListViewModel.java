 ...
 * @author: 廖华凯
 * @description:
 * @since: 2021/1/4 14:52
 * @company: 固远（深圳）信息技术有限公司
 **/
public class FinishedListViewModel extends BaseDearViewModel {
    public MutableLiveData<List<BaseContractBean>> contractList = new MutableLiveData<>(new ArrayList<>());
    public int searchType = BaseContractBean.CONTRACT_TYPE_FINISHED_CONTRACTS;
