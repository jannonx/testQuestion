...
import com.guyuan.dear.approve.fragment.PurchaseFragment;
 ...
 */
public class ApprovePurchaseActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {


    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApprovePurchaseActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        PurchaseFragment mFragment = PurchaseFragment.newInstance();
