...
import com.guyuan.dear.approve.fragment.OutFragment;
 ...
 */
public class ApproveOutActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {

    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApproveOutActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        OutFragment mFragment = OutFragment.newInstance();
