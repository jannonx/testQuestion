...
import com.guyuan.dear.approve.fragment.CommonApproveFragment;
...
public class ApproveCommonActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {
    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApproveCommonActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        CommonApproveFragment mFragment = CommonApproveFragment.newInstance();
