...
// */
//public abstract class BaseApproveFragment extends BaseDataBindingFragment {
...
//
////    @BindView(R.id.tfl_approver)
////    TagFlowLayout tflApprove;
////    @BindView(R.id.tfl_copy_to)
////    TagFlowLayout tflCopyTo;
//
...
////        BaseApproveActivity activity = (BaseApproveActivity) context;
...
//        }
//        AlertDialogUtils.pickTime(childManager, "请选择起始时间",
...
//        }
//        AlertDialogUtils.pickTime(childManager, "请选择结束时间",
...
//        }
//
//        AlertDialogUtils.pickTime(childManager, "请选择时间",
...
//
//
//    @OnClick({R.id.iv_approver, R.id.iv_copy_to, R.id.tv_btn_summit})
