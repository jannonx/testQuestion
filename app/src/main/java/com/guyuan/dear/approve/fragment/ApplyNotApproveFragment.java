...
// */
//public class ApplyNotApproveFragment extends BaseListFragment<FragmentListBinding> {
...
//        mPresenter.getApplyNotApproveList(RequestBody.create(MediaType.parse("application/json; " +
//                "charset=utf-8"), str));
//
//    }
//
