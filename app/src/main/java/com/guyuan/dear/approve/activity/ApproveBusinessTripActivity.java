...
import com.guyuan.dear.approve.fragment.BusinessTripFragment;
...
public class ApproveBusinessTripActivity  extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {

    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApproveBusinessTripActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        BusinessTripFragment mFragment = BusinessTripFragment.newInstance();
