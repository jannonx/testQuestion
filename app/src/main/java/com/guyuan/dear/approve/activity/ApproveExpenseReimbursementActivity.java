...
import com.guyuan.dear.approve.fragment.ExpenseReimbursementFragment;
 ...
 */
public class ApproveExpenseReimbursementActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {


    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApproveExpenseReimbursementActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        ExpenseReimbursementFragment mFragment = ExpenseReimbursementFragment.newInstance();
