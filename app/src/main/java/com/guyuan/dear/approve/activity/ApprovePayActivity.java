...
import com.guyuan.dear.approve.fragment.PayFragment;
 ...
 */
public class ApprovePayActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {


  public static void start(Context context, String title) {
    Intent starter = new Intent(context, ApprovePayActivity.class);
  ...
  protected void initFragment(Bundle savedInstanceState) {
    ...
    PayFragment mFragment = PayFragment.newInstance();
