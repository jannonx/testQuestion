...
import com.guyuan.dear.approve.fragment.ImprestFragment;
 ...
 */
public class ApprovePrettyCashActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {


    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApprovePrettyCashActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        ImprestFragment mFragment = ImprestFragment.newInstance();
