...
import com.guyuan.dear.approve.fragment.SealFragment;
 ...
 */
public class ApproveSealActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {

    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApproveSealActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        SealFragment mFragment = SealFragment.newInstance();
