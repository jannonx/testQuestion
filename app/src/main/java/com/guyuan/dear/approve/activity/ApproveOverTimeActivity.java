...
import com.guyuan.dear.approve.fragment.OverTimeFragment;
 ...
 */
public class ApproveOverTimeActivity extends BaseToolbarActivity<ActivityWithToolbarBinding, ApproveViewModel> {

    public static void start(Context context, String title) {
        Intent starter = new Intent(context, ApproveOverTimeActivity.class);
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        OverTimeFragment mFragment = OverTimeFragment.newInstance();
