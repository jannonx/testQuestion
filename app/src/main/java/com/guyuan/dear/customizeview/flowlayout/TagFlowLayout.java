package com.guyuan.dear.customizeview.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
  ...
  private int tagWidth = ViewGroup.LayoutParams.WRAP_CONTENT;//标签宽度，默认为自适应
  ...
  private void changeAdapter() {
    ...
    for (int i = 0; i < adapter.getCount(); i++) {
      ...
      ViewGroup.MarginLayoutParams lp = new ViewGroup.MarginLayoutParams(tagWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
