...
import com.guyuan.dear.utils.Graph.setting.LineChartSetting;
...
public class GraphUtil {
    ...
    //设置线性图
    public static void showLineChart(LineChart lineChart, List<List<Entry>> dataSets,
                                     List<String> legendList, List<Integer> colorList,int labelCount,
                                     IAxisValueFormatter xAxisFormatter, IAxisValueFormatter yAxisFormatter) {
        LineChartSetting.getInstance().initLineChart(lineChart)
                .setLegend()
                .setXAxis(xAxisFormatter, labelCount)
                .setYAxisLeft(yAxisFormatter)
                .setData(dataSets, legendList, colorList);
    }
