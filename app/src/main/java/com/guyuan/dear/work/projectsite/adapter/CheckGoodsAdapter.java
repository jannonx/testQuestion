 ...
 */
public class CheckGoodsAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public CheckGoodsAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
