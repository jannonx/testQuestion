 ...
 */
public class MaterialPurchaseAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public MaterialPurchaseAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
