 ...
 */
public class CheckGoodsFragment extends BaseListSearchFragment<SimpleTabBean, FragmentListBinding, WorkProjectSiteViewModel> {
    ...
    protected void init() {
        CheckGoodsAdapter checkGoodsAdapter = new CheckGoodsAdapter(getContext(),
                listData, R.layout.item_work_check_goods);
