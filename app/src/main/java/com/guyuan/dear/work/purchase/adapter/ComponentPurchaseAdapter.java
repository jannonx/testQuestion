package com.guyuan.dear.work.purchase.adapter;
 ...
 */
public class ComponentPurchaseAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public ComponentPurchaseAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
