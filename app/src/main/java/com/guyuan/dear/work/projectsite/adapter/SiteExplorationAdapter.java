 ...
 */
public class SiteExplorationAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public SiteExplorationAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
