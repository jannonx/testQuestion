 ...
 */
public class ClientAllAdapter extends BaseRecyclerAdapter<SimpleTabBean> {
    public ClientAllAdapter(Context context, @NonNull List<SimpleTabBean> listData, int layoutID) {
