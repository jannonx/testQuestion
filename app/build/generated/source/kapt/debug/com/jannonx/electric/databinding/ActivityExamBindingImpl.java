...
public class ActivityExamBindingImpl extends ActivityExamBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.jannonx.electric.R.layout.layout_home_bar});
    ...
    private ActivityExamBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.jannonx.electric.databinding.LayoutHomeBarBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeLlHomeBar((com.jannonx.electric.databinding.LayoutHomeBarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeLlHomeBar(com.jannonx.electric.databinding.LayoutHomeBarBinding LlHomeBar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
