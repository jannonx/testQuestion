...
public class ActivityBaseTabBindingImpl extends ActivityBaseTabBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.base_tl, 3);
    ...
    @Nullable
    private final com.example.mvvmlibrary.databinding.ToolbarBinding mboundView1;
    // variables
    // values
    // listeners
    // Inverse Binding Event Handlers

    public ActivityBaseTabBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityBaseTabBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.mboundView1 = (com.example.mvvmlibrary.databinding.ToolbarBinding) bindings[2];
