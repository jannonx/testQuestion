...
public class FragmentListBindingImpl extends FragmentListBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"empty"},
            new int[] {1},
            new int[] {com.guyuan.dear.R.layout.empty});
        sViewsWithIds = new android.util.SparseIntArray();
        sViewsWithIds.put(R.id.base_recycleView, 2);
    }
    // views
    // variables
    // values
    ...
    private FragmentListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (tl.com.easy_recycleview_library.BaseRecyclerView) bindings[2]
            , (com.guyuan.dear.databinding.EmptyBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeEmptyView((com.guyuan.dear.databinding.EmptyBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeEmptyView(com.guyuan.dear.databinding.EmptyBinding EmptyView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
