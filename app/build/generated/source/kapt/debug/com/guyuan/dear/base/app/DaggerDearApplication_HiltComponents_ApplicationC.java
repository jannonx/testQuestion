...
import com.guyuan.dear.base.api.ApiServiceModule;
import com.guyuan.dear.base.api.ApiServiceModule_GetCacheFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetCacheInterceptorFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetDebugOkHttpClientBuilderFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetDebugRetrofitFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetDebugSSLSocketFactoryFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetHeadInterceptorFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetHostnameVerifierFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetHttpLoggingInterceptorFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetKeyStoreFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetOkHttpClientBuilderFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetResponseInterceptorFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetRetrofitFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetSSLSocketFactoryFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetTrustManagerFactoryFactory;
import com.guyuan.dear.base.api.ApiServiceModule_GetX509TrustManagerFactory;
...
import com.guyuan.dear.home.data.MainViewModel_AssistedFactory;
import com.guyuan.dear.home.data.MainViewModel_AssistedFactory_Factory;
import com.guyuan.dear.home.hilt.MainModule;
import com.guyuan.dear.home.hilt.MainModule_ProvidesMainApiServiceFactory;
import com.guyuan.dear.home.hilt.MainModule_ProvidesMainRepositoryFactory;
import com.guyuan.dear.test.ExamActivity;
import com.guyuan.dear.test.data.TestRepository;
import com.guyuan.dear.test.data.TestViewModel_AssistedFactory;
import com.guyuan.dear.test.data.TestViewModel_AssistedFactory_Factory;
import com.guyuan.dear.test.hilt.TestModule;
import com.guyuan.dear.test.hilt.TestModule_ProvidesMainApiServiceFactory;
import com.guyuan.dear.test.hilt.TestModule_ProvidesMainRepositoryFactory;
  ...
  private final class ActivityRetainedCImpl extends DearApplication_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCImpl extends DearApplication_HiltComponents.ActivityC {
      ...
      private Map<String, Provider<ViewModelAssistedFactory<? extends ViewModel>>> getMapOfStringAndProviderOfViewModelAssistedFactoryOf(
        ...
        return MapBuilder.<String, Provider<ViewModelAssistedFactory<? extends ViewModel>>>newMapBuilder(2).put("com.guyuan.dear.home.data.MainViewModel", (Provider) getMainViewModel_AssistedFactoryProvider()).put("com.guyuan.dear.test.data.TestViewModel", (Provider) getTestViewModel_AssistedFactoryProvider()).build();
      }
      ...
      private final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.guyuan.dear.home.data.MainViewModel_AssistedFactory 
            return (T) ActivityCImpl.this.getMainViewModel_AssistedFactory();

            case 1: // com.guyuan.dear.home.data.MainRepository 
            return (T) ActivityCImpl.this.getMainRepository();

            case 2: // com.guyuan.dear.test.data.TestViewModel_AssistedFactory 
            return (T) ActivityCImpl.this.getTestViewModel_AssistedFactory();

            case 3: // com.guyuan.dear.test.data.TestRepository 
