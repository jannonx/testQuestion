...
public final class ApiServiceModule_GetDebugOkHttpClientBuilderFactory implements Factory<OkHttpClient.Builder> {
  ...
  public ApiServiceModule_GetDebugOkHttpClientBuilderFactory(ApiServiceModule module,
  ...
  public OkHttpClient.Builder get() {
    return getDebugOkHttpClientBuilder(module, sslSocketFactoryProvider.get(), x509TrustManagerProvider.get(), loggingInterceptorProvider.get(), headInterceptorProvider.get(), responseInterceptorProvider.get(), cacheInterceptorProvider.get(), homeNameVerifierProvider.get(), cacheProvider.get());
  }

  public static ApiServiceModule_GetDebugOkHttpClientBuilderFactory create(ApiServiceModule module,
      Provider<SSLSocketFactory> sslSocketFactoryProvider,
      Provider<X509TrustManager> x509TrustManagerProvider,
      Provider<HttpLoggingInterceptor> loggingInterceptorProvider,
      Provider<HeadInterceptor> headInterceptorProvider,
      ...
      Provider<CacheInterceptor> cacheInterceptorProvider,
      Provider<HostnameVerifier> homeNameVerifierProvider, Provider<Cache> cacheProvider) {
    return new ApiServiceModule_GetDebugOkHttpClientBuilderFactory(module, sslSocketFactoryProvider, x509TrustManagerProvider, loggingInterceptorProvider, headInterceptorProvider, responseInterceptorProvider, cacheInterceptorProvider, homeNameVerifierProvider, cacheProvider);
  }

  public static OkHttpClient.Builder getDebugOkHttpClientBuilder(ApiServiceModule instance,
    ...
    return Preconditions.checkNotNull(instance.getDebugOkHttpClientBuilder(sslSocketFactory, x509TrustManager, loggingInterceptor, headInterceptor, responseInterceptor, cacheInterceptor, homeNameVerifier, cache), "Cannot return null from a non-@Nullable @Provides method");
  }
}
